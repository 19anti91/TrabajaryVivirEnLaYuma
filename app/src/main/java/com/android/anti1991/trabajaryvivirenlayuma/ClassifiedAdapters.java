...
public class ClassifiedAdapters extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private List<ViewModel> models = new ArrayList<>();
    private List<ClassifiedCategories> categories = new ArrayList<>();
     ...
     */
    public ClassifiedAdapters(final List<ViewModel> viewModels) {
        if (viewModels != null) {
...
/*
    public ClassifiedAdapters(final List<ClassifiedCategories> categories, String test) {
        if (categories != null) {
            this.models.addAll(categories);
        }
    }
    /**
